  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 mb-5 shrink-0">
        ...
        <span
          className={`ml-auto shrink-0 font-poppins text-sm font-medium px-2.5 py-1 rounded-full whitespace-nowrap ${allComplete
      ...
      {view === "overview" ? (
        ...
        <div
          className={`space-y-3 ${compact ? "overflow-y-auto min-h-0 -mx-1 px-1" : ""
            }`}
        >
          {groupPlanInstances(sortedInstances).map((group) => {
            ...
            return (
              <div
                key={group.sig}
                className={`bg-white rounded-xl border px-3.5 py-3 ${groupComplete ? "border-green-300" : "border-brand-divider"
                  }`}
              >
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <span
                    className={`ml-auto shrink-0 font-poppins text-[0.7rem] font-semibold px-2 py-0.5 rounded-full tabular-nums ${groupComplete
        ...
        <div
          ref={listRef}
          className={`space-y-4 ${compact ? "overflow-y-auto min-h-0 -mx-1 px-1" : ""
            }`}
        >
          ...
          {sortedInstances.map((pi) => {
            ...
            return (
              <div
                ...
                className={`rounded-xl p-3 transition-[border-color,background-color,box-shadow] duration-200 cursor-pointer select-none ${isActive
              ...
              >
                ...
                <div className="flex items-center justify-between mb-2.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`font-poppins text-xs font-semibold ${isActive
                        ? "text-brand-primary"
                        : "text-brand-text/70"
                        }`}
                    >
                  ...
                  <span
                    className={`font-poppins text-xs font-medium px-2 py-0.5 rounded-full ${isComplete
                      ? "bg-green-200/60 text-green-700"
                      : isActive
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1.5 mb-1.5">
                          ...
                          {compact && (
                            <span
                              className={`ml-auto font-poppins text-[0.65rem] font-semibold whitespace-nowrap ${categoryComplete
                                ? "text-green-600"
                                : "text-brand-text/40"
                                }`}
                              title={`${filled} of ${max} ${label.toLowerCase()}${max === 1 ? "" : "es"
                                } chosen for this box`}
                            >
                          ...
                          {catItems.map((item) => {
                            ...
                            return (
                              <div
                                ...
                                className={`cursor-grab active:cursor-grabbing transition-[border-color,opacity,transform] duration-150 ${compact
                                  ...
                                  : "w-10 h-10 rounded-lg overflow-hidden bg-brand-secondary"
                                    ...
                                    ? `opacity-40 border-2 border-brand-primary/50 ${compact ? "" : "scale-90"
                                    }`
                                    : isSwapTarget
                                      ? `ring-2 ring-brand-accent border-2 border-brand-accent shadow-md ${compact ? "" : "scale-110"
                                      }`
                              ...
                              >
                                <img
                                  ...
                                  onError={onImgError}
                                  alt={item.name}
                                  className={`object-cover pointer-events-none ${compact
                          ...
                          {Array.from({
                            ...
                            return (
                              <div
                                ...
                                className={`border-2 border-dashed transition-[border-color,opacity,transform] duration-150 ${compact
                                  ? // min-h keeps the empty row a 44px touch target
                                  "flex items-center gap-2 w-full rounded-lg p-1 pr-2 min-h-[2.75rem]"
                                  : "w-10 h-10 rounded-lg flex items-center justify-center"
                                  } ${isSlotDropTarget
                                    ? `border-brand-accent bg-brand-accent/10 shadow-md ${compact ? "" : "scale-110"
                                    }`
                                    : isValidDrop
                        ...
                        {!compact && (
                          <p
                            className={`font-poppins text-xs mt-1.5 ${categoryComplete
      ...
      {/* Footer CTA — always rendered so it stays pinned below the scrolling
          ...
          checkout. */}
      <div
        className={`mt-5 pt-5 border-t shrink-0 ${allComplete && !dishesShort ? "border-green-200" : "border-brand-divider/60"
          }`}
      >
        <button
          onClick={() => {
          ...
          className={`w-full group flex items-center justify-center gap-3 py-4 rounded-xl font-arvo font-bold text-lg transition-[box-shadow,transform,background-color] ${!allComplete
          ...
          aria-label={
            !allComplete
              ...
              : dishesShort
                ? `${dishMin.violations.length} ${dishMin.violations.length === 1 ? "dish is" : "dishes are"
