...
const ServiceOptions: React.FC<ServiceOptionsProps> = ({ addMessage }) => (
  <div className="flex flex-col gap-2 mt-2 w-full animate-in fade-in duration-500">
    <button
      ...
      onClick={(e) => {
        e.preventDefault();
        e.stopPropagation();
        addMessage("I'd like to order Check-a-Lunch", "user");
        window.location.href = "/services/check-a-lunch";
      }}
    >
