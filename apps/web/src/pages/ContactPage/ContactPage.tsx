...
const ContactPage: React.FC = () => {
  ...
  return (
    // min-h accounts for the fixed nav's offset (pt-16/md:pt-20 on <main>),
    // so the block centres in the VISIBLE viewport with no stray scrollbar.
    <div className="bg-brand-secondary min-h-[calc(100dvh-4rem)] md:min-h-[calc(100dvh-5rem)] flex flex-col">
      <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 md:px-10 lg:px-12 py-10 md:py-12 flex-1 flex items-center">
